...
func main() {
	...
	admin.Use(
		moviesHandler.AdminMiddleware,
		genresHandler.AdminMiddleware,
		agesHandlers.AdminMiddleware,
		categoryHandlers.AdminMiddleware,
		allseriesHandlers.AdminMiddleware,
		usersHandlers.AdminMiddleware)
	{
		...
		admin.POST("/allseries", allseriesHandlers.Create)
		admin.PUT("/allseries/:id", allseriesHandlers.Update)
		admin.DELETE("/allseries/:id", allseriesHandlers.Delete)
	...
	authorized.GET("/movies/:id", moviesHandler.FindByIdforUsers)
	...
	authorized.GET("/allseries", allseriesHandlers.FindAll)
